...
original_dataset = pd.read_csv('datasets/diabetes-reduced.csv')
...
# Save the datasets
male_dataset.to_csv('datasets/male.csv', index=False)
female_dataset.to_csv('datasets/female.csv', index=False)