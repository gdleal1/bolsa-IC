...
datasets = {
    "outputs/outputs_complex/output-heart-disease.csv": "Original",
    "outputs/outputs_complex/output-female.csv": "Female",
    "outputs/outputs_complex/output-male.csv": "Male",
    "outputs/outputs_complex/output-elderly.csv": "Elderly",
    "outputs/outputs_complex/output-adult.csv": "Adult"
}
...
plt.figure(figsize=(12, 6))
complexity_df[["Original", "Elderly", "Adult"]].plot(
...
plt.grid(axis="y", linestyle="--", alpha=0.7)
plt.tight_layout()
plt.savefig("graphics\\graphics_compare\\original-elderly-adult.png")
